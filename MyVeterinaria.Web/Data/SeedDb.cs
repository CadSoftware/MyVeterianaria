...
namespace MyVeterinaria.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            {
                var manager = await CheckUserAsync("25843997", "Cristian Agustin", "Daud", "cdaud777@gmail.com",
                    "350 634 2747", "Maipu 41", "Admin");
                await CheckManagerAsync(manager);
            }

            if (!_dataContext.Owners.Any())
            {
                var customer = await CheckUserAsync("24059797", "Mariana", "Barraza", "mariana777@hotmail.com",
                    "350 634 2747", "Maipu 41", "Customer");
