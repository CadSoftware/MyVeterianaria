...
namespace MyVeterinaria.Web.Migrations
{
    ...
    [Migration("20191115144829_Owners")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVeterinaria.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyVeterinaria.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyVeterinaria.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVeterinaria.Web.Data.Entities.Manager", b =>
                {
                    b.HasOne("MyVeterinaria.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
